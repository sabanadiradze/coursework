                ...
                <div className="container">
                    ...
                    <div className="row justify-content-center">
                        <div className="col-md-4">
                            <Link to="/modules/0/chapters" className="card mb-4 text-decoration-none text-dark">
                        ...
                        <div className="col-md-4">
                            <Link to="/modules/1/chapters" className="card mb-4 text-decoration-none text-dark">
                                <div className="card-body">
